      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="relative flex flex-col items-center justify-center gap-6">
          ...
          <div className="flex items-center gap-8">
            <Link 
              href="https://github.com/neerajpatil099" 
              target="_blank"
            ...
            <Link 
              href="https://www.linkedin.com/in/neeraj-patil-094" 
              target="_blank"
              className="group relative"
              aria-label="LinkedIn"
            >
            ...
            <Link 
              href="https://medium.com/@neerajpatil099" 
              target="_blank"
              className="group relative"
              aria-label="Medium"
            >
              <div className="absolute -inset-2 rounded-full bg-gradient-to-r from-cyan-500 to-purple-500 opacity-0 blur-md transition-all duration-500 group-hover:opacity-20 group-hover:scale-110" />
              <svg className="w-6 h-6 text-zinc-400 transition-all duration-300 group-hover:text-white group-hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
